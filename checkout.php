...
?>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                <a class="nav-link active" href="index.html">Welcome <?php echo $fetch_user['name']; ?></a>
              </li>
              <li><a href=""></a></li>
  ...
  <!-- <section id="thank-you">
    <div class="container">
        <h1><span>Thank you for Shopping</span><br> at DASHIN.</h1>
        ...
        <button class="btn btn-primary">Continue Shopping 
            <a href="index.html"><i class="fa fa-arrow-right"></i></a>
        </button>
    </div>
</section> -->
            ...
            <div class="col-md-6">
                ...
                <form>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="fullName" placeholder="<?php echo $fetch_user['name']; ?>">
                    </div>
                    <div class="form-group">
                        <label for="email">Email Address</label>
                        <input type="email" class="form-control" id="email" placeholder="<?php echo $fetch_user['email']; ?>">
                    </div>
                    <div class="form-group">
